...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Route::prefix('api/super_admin')
            ->middleware('api')
            ->namespace($this->namespace)
            ->group(base_path('routes/api/super_admin.php'));
        Route::prefix('api/technical')
            ->middleware('api')
            ->namespace($this->namespace)
            ->group(base_path('routes/api/technical.php'));
        ...
        Route::prefix('api/accountant')
            ->namespace($this->namespace)
            ->group(base_path('routes/api/accountant.php'));
    }
}

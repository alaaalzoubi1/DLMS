...
<a href="#" class="legal-link">{{$content['site_content']['footer']['links']['privacy_policy'] ?? 'سياسة الخصوصية'}}</a>
                ...
                <a href="javascript:void(0)" onclick="openTerms()">{{$content['site_content']['footer']['links']['terms_of_service'] ?? 'شروط الخدمة'}}</a>

            </div>
            <p class="security-note">
                <i class="fas fa-shield-alt"></i>
               {{$content['site_content']['footer']['security_note'] ?? 'جميع المدفوعات مشفرة ومؤمنة.'}}
            </p>
        </div>
    </footer>
